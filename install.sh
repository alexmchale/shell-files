...
announce "Installing Vim modules"

mkdir -p ~/.vimbundles
cd ~/.vimbundles
clone_or_update rails git://github.com/tpope/vim-rails.git
clone_or_update haml git://github.com/tpope/vim-haml.git
clone_or_update nerdtree git://github.com/scrooloose/nerdtree.git
clone_or_update vividchalk http://github.com/tpope/vim-vividchalk.git
clone_or_update matchit http://github.com/tsaleh/vim-matchit.git
clone_or_update fugitive http://github.com/tpope/vim-fugitive.git
clone_or_update coffee-script http://github.com/kchmck/vim-coffee-script.git
clone_or_update surround http://github.com/tpope/vim-surround.git
clone_or_update gist http://github.com/mattn/gist-vim.git
clone_or_update endwise http://github.com/tpope/vim-endwise.git
clone_or_update align https://github.com/tsaleh/vim-align.git
clone_or_update command-t git://git.wincent.com/command-t.git
clone_or_update zencoding https://github.com/mattn/zencoding-vim.git



## Command-T ##

announce "Building Command-T for Vim"

cd ~/.vimbundles/command-t/ruby/command-t
